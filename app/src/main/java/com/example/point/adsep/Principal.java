...
public class Principal extends AppCompatActivity
    ...
    */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.psimulador) {
            Intent intent=new Intent(getApplicationContext(),Simulador.class);
            startActivity(intent);
        } else if (id == R.id.potra) {

        } else if (id == R.id.psalir) {
            System.exit(0);
        } else if (id == R.id.padsep) {
    ...
    public void onClickGuias(View vi){
        Intent intent=new Intent(getApplicationContext(),Guias.class);
        startActivity(intent);
    }

    public void onClickSimulador(View vi){
        Intent intent=new Intent(getApplicationContext(),Simulador.class);
        startActivity(intent);
    }
}
